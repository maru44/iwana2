...
class Wanted(models.Model):
    slug = models.SlugField(_('slug'), max_length=16, unique=True, blank=True, null=True)
...
class Offer(models.Model):
    ...
    how_good = models.CharField(_("フィット感"), max_length=2, choices=HowGood.choices, blank=True, null=True)
